...
| `tests/listener-network-resilience.spec.ts` | ffmpeg fixture | achieved forward buffer, 5/15/30/60-second media outages, refill, same lease and privacy-safe diagnostics in Chromium, Firefox, Android emulation and WebKit |
