...
export const earlyBirdHomeCopy = {
    es: {
        ...
        subheading: 'Estás compartiendo el mismo punto del stream Beacon 24/7 con las demás personas EarlyBird.',
        play: 'Escuchar ahora',
        ...
        playWithIntro: 'Play con intro',
        playBeaconOnly: 'Play · solo Beacon',
        stop: 'Stop',
        playingIntro: 'Sonando intro · después sigue el Beacon',
        playingBeacon: 'Sonando Beacon 24/7',
        stopped: 'Detenido',
    ...
    en: {
        ...
        subheading: 'You are sharing the same point in the Beacon 24/7 stream with every other EarlyBird listener.',
        play: 'Listen now',
        ...
        playWithIntro: 'Play with intro',
        playBeaconOnly: 'Play · Beacon only',
        stop: 'Stop',
        playingIntro: 'Playing intro · Beacon follows',
        playingBeacon: 'Playing Beacon 24/7',
        stopped: 'Stopped',
