...
export const earlyBirdCopy = {
    es: {
        ...
        accessUnavailable: 'No pudimos consultar tu horario o membresía. No mostraremos un estado estimado.',
    ...
    en: {
        ...
        accessUnavailable: 'We could not check your schedule or membership. We will not show an estimated state.',
