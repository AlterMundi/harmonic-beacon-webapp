...
export const earlyBirdCopy = {
    es: {
        ...
        membershipManageIntro: 'Consulta tu acceso y administra tu membresía en un solo lugar.',
    ...
    en: {
        ...
        membershipManageIntro: 'Review your access and manage your membership in one place.',
