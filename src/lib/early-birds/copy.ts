...
export const earlyBirdHomeCopy = {
    es: {
        ...
        subheading: 'Un mismo punto del Beacon, disponible para quienes están escuchando alrededor del mundo.',
        ready: 'Listo para escuchar',
        listen: 'Escuchar',
        mode: 'Cómo querés entrar',
        withIntro: 'Con introducción',
        beaconOnly: 'Solo Beacon',
        beaconFollows: 'Después sigue el Beacon',
        introBy: 'Amara Sol · English',
    ...
    en: {
        ...
        subheading: 'One point in the Beacon, available to everyone listening across the world.',
        ready: 'Ready to listen',
        listen: 'Listen',
        mode: 'How you want to enter',
        withIntro: 'With introduction',
        beaconOnly: 'Beacon only',
        beaconFollows: 'The Beacon follows',
        introBy: 'Amara Sol · English',
