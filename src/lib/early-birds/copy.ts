...
export const earlyBirdCopy = {
    es: {
        ...
        membershipPurchaseUnavailable: 'La membresía no está disponible para compra en este momento.',
        ...
        authError: 'No pudimos completar el acceso.',
        authRecoveryTitle: 'No pudimos completar el acceso.',
        authRecoveryDetail: 'Limpiaremos solamente este intento y la sesión Listener para que puedas elegir otra cuenta de forma segura.',
        authRecoveryAction: 'Usar otra cuenta',
        authRecoveryWorking: 'Preparando un acceso nuevo…',
        identityRecoveryFailed: 'No pudimos preparar un acceso nuevo. Inténtalo nuevamente.',
        ...
        membershipManageEyebrow: 'HARMONIC BEACON · LISTENER',
        membershipManageTitle: 'Membresía',
        membershipManageIntro: 'Escucha sin límite y ayuda a sostener el desarrollo de Harmonic Beacon.',
        membershipBackToListener: 'Volver a Listener',
        membershipManageAction: 'Administrar membresía',
        membershipSubscribeAction: 'Suscribirme · USD 5/mes',
    ...
    en: {
        ...
        membershipPurchaseUnavailable: 'Membership is not available for purchase right now.',
        ...
        authError: 'We could not complete sign-in.',
        authRecoveryTitle: 'We could not complete sign-in.',
        authRecoveryDetail: 'We will clear only this attempt and the Listener session so you can safely choose another account.',
        authRecoveryAction: 'Use another account',
        authRecoveryWorking: 'Preparing a new sign-in…',
        identityRecoveryFailed: 'We could not prepare a new sign-in. Please try again.',
        ...
        membershipManageEyebrow: 'HARMONIC BEACON · LISTENER',
        membershipManageTitle: 'Membership',
        membershipManageIntro: 'Listen without limits and support Harmonic Beacon’s development.',
        membershipBackToListener: 'Back to Listener',
        membershipManageAction: 'Manage membership',
        membershipSubscribeAction: 'Subscribe · USD 5/month',
