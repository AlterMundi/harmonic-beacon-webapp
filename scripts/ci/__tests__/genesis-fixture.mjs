...
function authorization(operation = 'genesis') {
  ...
  return {
    ...
    authorizerSourceSha: 'a'.repeat(40), authorizerSourceTree: 'b'.repeat(40),
    manifestSha256: H('manifest').slice(7), configSha256: H('config'),
...
function rehearsal() {
  ...
  return {
    ...
    sourceSha: a.sourceSha, sourceTree: a.sourceTree,
    authorizerSourceSha: a.authorizerSourceSha, authorizerSourceTree: a.authorizerSourceTree,
    candidateRunId: a.candidateRunId, candidateRunAttempt: a.candidateRunAttempt,
