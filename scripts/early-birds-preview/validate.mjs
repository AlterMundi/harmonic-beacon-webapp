...
try {
  ...
  assert.equal(listener.environment.BEACON_LISTENER_ACCOUNT_ENABLED, '0');
  assert.equal(listener.environment.BEACON_LISTENER_ACCOUNT_ENVIRONMENT, 'production');
  assert.equal(listener.environment.BEACON_LISTENER_ACCOUNT_CLIENT_SECRET, '');
  assert.equal(listener.environment.BEACON_LISTENER_ACCOUNT_STATE_SECRET, '');
  assert.equal(listener.environment.BEACON_LISTENER_ACCOUNT_CLIENT_SECRET_STAGING, undefined);
  assert.equal(listener.environment.BEACON_LISTENER_ACCOUNT_STATE_SECRET_STAGING, undefined);
